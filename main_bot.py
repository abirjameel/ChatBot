...
from resources.dialogue_manager import DialogueManager
...
class BotHandler(object):
    ...
    def get_answer(self, question):
        if question == '/start':
            return "Hi, I am Bob! I am here to help you on your programming stuff, I can also talk cool!"
                ...
                if "text" in update["message"]:
                    ...
                    if is_unicode(text):
                        ...
                        bot.send_message(chat_id,
                                         "Hmm, you are sending some weird characters to me...I am not yet prepared for this!")
